...
class Create extends Component
{
    ...
    public function save(): \Illuminate\Http\RedirectResponse
    {
        ...
        $payrollType = HcmPayrollType::create([
            'team_id' => $teamId,
            'code' => $this->form['code'],
            'lanr' => $this->form['lanr'],
            'name' => $this->form['name'],
        ...
        return redirect()->route('hcm.payroll-types.show', $payrollType);
    }

    public function render()
    {
        return view('hcm::livewire.payroll-type.create')->layout('platform::layouts.app');
    }
}
