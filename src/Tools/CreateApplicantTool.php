...
class CreateApplicantTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'hcm.applicants.POST';
    }

    public function getDescription(): string
    {
        return 'POST /hcm/applicants - Erstellt einen Bewerber. Ein CRM-Contact MUSS verknüpft werden (entweder contact_id oder create_contact).';
    }
    ...
    public function getSchema(): array
    {
        return $this->mergeWriteSchema([
            'properties' => [
                ...
                'applicant_status_id' => [
                    'type' => 'integer',
                    'description' => 'Optional: Bewerbungsstatus. Nutze "hcm.lookup.GET" mit lookup=applicant_statuses.',
                ],
                'applied_at' => [
                    'type' => 'string',
        ...
        try {
            ...
            $result = DB::transaction(function () use ($teamId, $context, $contactId, $createContact, $isActive, $ownedByUserId, $arguments) {
                $applicant = HcmApplicant::create([
                    'applicant_status_id' => isset($arguments['applicant_status_id']) ? (int)$arguments['applicant_status_id'] : null,
                ...
                CrmContactLink::firstOrCreate(
                    [
                        ...
                        'linkable_type' => HcmApplicant::class,
