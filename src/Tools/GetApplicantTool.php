...
class GetApplicantTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'hcm.applicant.GET';
    }

    public function getDescription(): string
    {
        return 'GET /hcm/applicants/{id} - Ruft einen einzelnen Bewerber ab (inkl. Status, CRM-Verknüpfungen). Parameter: applicant_id (required), team_id (optional).';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                'applicant_id' => [
                    'type' => 'integer',
                    'description' => 'ID des Bewerbers (ERFORDERLICH). Nutze "hcm.applicants.GET" um IDs zu finden.',
                ],
                'team_id' => [
                    'type' => 'integer',
