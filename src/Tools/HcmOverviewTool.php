...
class HcmOverviewTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /hcm/overview - Zeigt Übersicht über HCM-Konzepte (Employee, Contract, Employer) und die Verknüpfung Richtung CRM. Bewerber/Recruiting: siehe recruiting.overview.GET. REST-Parameter: keine.';
    }
        ...
        try {
            return ToolResult::success([
                ...
                'concepts' => [
                    ...
                    'applicants' => [
                        'note' => 'VERALTET: Bewerber sind jetzt im Recruiting-Modul. Nutze recruiting.overview.GET.',
                        'redirect' => 'recruiting.overview.GET',
                    ],
                ],
                'crm_linking' => [
                ...
                'related_tools' => [
                    ...
                    'recruiting' => [
                        'overview' => 'recruiting.overview.GET',
                        'note' => 'Bewerber, Positionen, Ausschreibungen → Recruiting-Modul',
                    ],
                    'crm' => [
