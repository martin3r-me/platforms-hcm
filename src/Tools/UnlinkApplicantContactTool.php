...
class UnlinkApplicantContactTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'hcm.applicant_contacts.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /hcm/applicants/{applicant_id}/contacts/{contact_id} - Entfernt die Verknuepfung zwischen Bewerber und CRM Contact. Parameter: applicant_id (required), contact_id (required), confirm (optional).';
    }
    ...
    public function getMetadata(): array
    {
        return [
            'read_only' => false,
            'category' => 'action',
            'tags' => ['hcm', 'applicant', 'crm', 'link', 'delete'],
            'risk_level' => 'write',
            'requires_auth' => true,
            'requires_team' => true,
            'idempotent' => true,
