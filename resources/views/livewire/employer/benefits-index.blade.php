<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar :title="'Benefits: ' . $employer->display_name" icon="heroicon-o-gift">
            <div class="flex items-center gap-2">
                <a href="{{ route('hcm.employers.show', $employer) }}" class="text-sm text-[var(--ui-muted)] hover:text-[var(--ui-secondary)]" wire:navigate>
        ...
        <div class="bg-white rounded-lg border border-[var(--ui-border)]/60 p-6 mb-6">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-sm text-[var(--ui-muted)] mt-1">Alle Benefits für {{ $employer->display_name }}</p>
                </div>
