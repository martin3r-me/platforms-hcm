<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar title="Beschäftigungsverhältnisse" icon="heroicon-o-briefcase" />
    </x-slot>

    <x-ui-page-container>
        <div class="px-4 sm:px-6 lg:px-8">
            <x-ui-panel title="Übersicht" subtitle="Beschäftigungsverhältnisse verwalten">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-8 text-center text-[var(--ui-muted)]">
                                        Keine Beschäftigungsverhältnisse gefunden
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center p-3 bg-[var(--ui-muted-5)] rounded-lg">
                            ...
                            <span class="font-semibold text-[var(--ui-secondary)]">{{ $items->total() }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 space-y-4">
                ...
                <div class="space-y-3 text-sm">
                    <div class="p-2 rounded border border-[var(--ui-border)]/60 bg-[var(--ui-muted-5)]">
                        <div class="font-medium text-[var(--ui-secondary)] truncate">Beschäftigungsverhältnisse-Übersicht geladen</div>
    ...
    <x-ui-modal wire:model="showCreateModal">
        <x-slot name="header">Neues Beschäftigungsverhältnis anlegen</x-slot>
        <div class="space-y-4">
    ...
    <x-ui-modal wire:model="showEditModal">
        <x-slot name="header">Beschäftigungsverhältnis bearbeiten</x-slot>
        <div class="space-y-4">
            <x-ui-input-text name="code" label="Code" wire:model="code" required />
            <x-ui-input-text name="name" label="Name" wire:model="name" required />
            <x-ui-input-textarea name="description" label="Beschreibung" wire:model="description" />
