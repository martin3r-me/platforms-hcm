    ...
    <x-ui-page-container>
        ...
        <x-ui-modal wire:model="modalShow" title="Neuen Export erstellen">
            <div class="space-y-4">
                ...
                @if(in_array($selectedExportType, ['infoniqa-ma', 'infoniqa-dimensions', 'infoniqa-bank'], true))
                    <div>
                        <label class="block text-sm font-medium text-[var(--ui-secondary)] mb-2">
            ...
            <x-slot name="footer">
                <div class="flex justify-end gap-3">
                    ...
                    <x-ui-button 
                        ...
                        :disabled="!$selectedExportType || (in_array($selectedExportType, ['infoniqa-ma','infoniqa-dimensions','infoniqa-bank'], true) && !$selectedEmployerId)"
                    >
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <x-ui-button variant="secondary-outline" size="sm" wire:click="triggerExport('infoniqa-bank')" class="w-full justify-start">
                            @svg('heroicon-o-banknotes', 'w-4 h-4')
                            <span class="ml-2">INFONIQA Bank</span>
                        </x-ui-button>
