<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar title="Versicherungsstatus" icon="heroicon-o-shield-check" />
    </x-slot>

    <x-ui-page-container>
        <div class="px-4 sm:px-6 lg:px-8">
            <x-ui-panel title="Übersicht" subtitle="Versicherungsstatus verwalten">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-8 text-center text-[var(--ui-muted)]">
                                        Keine Versicherungsstatus gefunden
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="p-4 space-y-4">
                ...
                <div class="space-y-3 text-sm">
                    <div class="p-2 rounded border border-[var(--ui-border)]/60 bg-[var(--ui-muted-5)]">
                        <div class="font-medium text-[var(--ui-secondary)] truncate">Versicherungsstatus-Übersicht geladen</div>
    ...
    <x-ui-modal wire:model="showCreateModal">
        <x-slot name="header">Neuen Versicherungsstatus anlegen</x-slot>
        <div class="space-y-4">
    ...
    <x-ui-modal wire:model="showEditModal">
        <x-slot name="header">Versicherungsstatus bearbeiten</x-slot>
        <div class="space-y-4">
            <x-ui-input-text name="code" label="Code" wire:model="code" required />
            <x-ui-input-text name="name" label="Name" wire:model="name" required />
            <x-ui-input-textarea name="description" label="Beschreibung" wire:model="description" />
