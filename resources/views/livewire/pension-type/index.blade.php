<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar title="Rentenarten" icon="heroicon-o-academic-cap" />
    </x-slot>

    <x-ui-page-container>
        <div class="px-4 sm:px-6 lg:px-8">
            <x-ui-panel title="Übersicht" subtitle="Rentenarten verwalten">
            ...
            <div class="p-4 space-y-4">
                ...
                <div class="space-y-3 text-sm">
                    <div class="p-2 rounded border border-[var(--ui-border)]/60 bg-[var(--ui-muted-5)]">
                        <div class="font-medium text-[var(--ui-secondary)] truncate">Rentenarten-Übersicht geladen</div>
