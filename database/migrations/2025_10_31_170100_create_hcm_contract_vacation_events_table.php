...
return new class extends Migration {
    ...
    {
        Schema::create('hcm_contract_vacation_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('vacation_entitlement', 6, 2)->nullable();
            $table->decimal('vacation_prev_year', 6, 2)->nullable();
            $table->decimal('vacation_taken', 6, 2)->nullable();
    ...
    {
        Schema::dropIfExists('hcm_contract_vacation_events');
    }
};
